export default function BootstrapThemeKit() {
  return (
    <>
        ...
        <div className="row mt-3">
          <div className="col-lg-4 col-md-6">
            <div className="mt-3 mb-3">
              <p>Hello this is body text, Documentation and examples for common text utilities to control alignment, wrapping, weight, and more.</p>
            </div>
            ...
            <div className="mt-3 mb-3">
              ...
              <div className="row mt-5 mb-3">
                <div className="col-3 p-4 border border-primary me-2 my-2" />
                <div className="col-3 p-4 border border-secondary me-2 my-2" />
                <div className="col-3 p-4 border border-success me-2 my-2" />
                <div className="col-3 p-4 border border-danger me-2 my-2" />
                <div className="col-3 p-4 border border-warning me-2 my-2" />
                <div className="col-3 p-4 border border-info me-2 my-2" />
                <div className="col-3 p-4 border border-light me-2 my-2" />
                <div className="col-3 p-4 border border-dark me-2 my-2" />
                <div className="col-3 p-4 border border-white me-2 my-2" />
              </div>
              <div className="row mt-3 mb-3 d-flex d-block">
                <div className="col-3 p-4 border border-1 me-2 my-2" />
                <div className="col-3 p-4 border border-2 me-2 my-2" />
                <div className="col-3 p-4 border border-3 me-2 my-2" />
                <div className="col-3 p-4 border border-4 me-2 my-2" />
                <div className="col-3 p-4 border border-5 me-2 my-2" />
              </div>
              <div className="mt-3 mb-3">
